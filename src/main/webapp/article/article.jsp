...
<script>
    ...
    $(function(){
        $("#atctable").jqGrid({
            ...
            colNames : [ 'Id','封面', '标题', '内容简要', '上传时间', '状态','上师ID','操作'],
            colModel : [
                {name : 'id',width : 55},
                ...
                {name : 'content',editable:true,width : 90},
                {name : 'up_date',width : 80},
                ...
                {name : 'guruid',width : 80,align : "center"},
                {name : '操作',editable:true,width : 80,align : "center"}
            ]
        ...
        $("#atctable").jqGrid('navGrid', '#atcpager',
            {edit : false,add : false,search:false,del : true,addtext:"添加",edittext:"编辑"},
            {
                closeAfterEdit:true,
                beforeShowForm:function(data){
                    data.find("#insert_img").attr("disabled",false)
                }
            },
            {
